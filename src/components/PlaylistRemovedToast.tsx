...
import { XCircle, ListX, X } from "lucide-react";
...
export function PlaylistRemovedToast({
  playlistTitle,
  videoTitle,
  videoThumb,
  onClose,
        ...
        <div className="flex items-center gap-3 px-4 py-3.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              <ListX className="h-3 w-3 text-destructive flex-shrink-0" />
              <p className="text-xs text-destructive font-medium truncate">{playlistTitle}</p>
            </div>
            {videoTitle && (
